...
wget -O "/root/speedtest" "https://cdn.000714.xyz/BlueSkyXN/ChangeSource/master/speedtest" --no-check-certificate -T 30 -t 5 -d
chmod +x "/root/speedtest"
chmod 777 "/root/speedtest"
wget -O "/root/besttrace" "https://cdn.000714.xyz/BlueSkyXN/ChangeSource/master/besttrace" --no-check-certificate -T 30 -t 5 -d
